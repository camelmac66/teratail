...
class TabViewController: TabmanViewController {
  ...
  override func viewDidLoad() {
    ...
    guard
      let firstVC = UIStoryboard(name: "FirstViewController", bundle: nil).instantiateInitialViewController(),
      let secondVC = UIStoryboard(name: "SecondViewController", bundle: nil).instantiateInitialViewController()
      else {
        return
    }
